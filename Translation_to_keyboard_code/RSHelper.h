...
extern void draw_pointcloud_2(float width, float height, glfw_state& app_state, rs2::points& points, int fake);

extern void register_glfw_callbacks(window& app, glfw_state& app_state);