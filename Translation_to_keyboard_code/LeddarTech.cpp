...
std::array<double,16> LeddarTech::GetValues() {
	...
	if (lSensor) {
		...
		retval = { {1.08239220029239,1.060848699585,1.0429489127458,1.02841519366521,1.01703026581127,1.00862896058015,1.00309219848283,1.00034279249087,1.00034279249087,1.00309219848283,1.00862896058015,1.01703026581127,1.02841519366521,1.0429489127458,1.060848699585,1.08239220029239
} };
